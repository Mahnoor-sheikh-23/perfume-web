    ...
    return (
        <div>
            ...
            <div className='flex flex-col md:flex-row  justify-evenly mt-16 text-gray-700'>
                <div className=' md:w-[400px] w-auto h-[1650px] '>
                    <div className='w-[400px] h-[1650px] border border-black'>
                        <div>
                        ...
                        <div className='mt-6'>
                            ...
                            <div className=' mt-9 m-4' >
                                ...
                                <div className='border border-black '>
                                    <div className='flex justify-between  pb-2 border-b border-black'>
                                        <p className='pl-2 text-[20px]'>The highest price is Rs.200,812.00Default input value is PKR                                   </p>
                                        <p className='pr-2 underline text-[20px]'>Reset</p>
                                    </div>
                                    <div className='space-y-3 mt-3 mb-3  text-[20px] p-2'>
                                        <div>
                            ...
                            <div className=' mt-9 m-4' >
                                <p className='text-[26px] p-2 font-bold'> Fragnance By Type</p>
                                <div className='border border-black '>
                                    <div className='flex justify-between  pb-2 border-b border-black'>
                                        <p className='pl-2 text-[20px]'>0 Selected</p>
                                        <p className='pr-2 underline text-[20px]'>Reset</p>
                                    ...
                                    <div className='space-y-3 mt-3 mb-3  text-[20px] p-2'>
                                        ...
                                        <div>
                                            <input type='checkbox' />&nbsp;
                                            <label>Men Fragnances (324) </label>
                                        </div>
                                        <div>
                                            <input type='checkbox' />&nbsp;
                                            <label>Unisex Fragnances (65) </label>
                                        </div>
                                        <div>
                                            <input type='checkbox' />&nbsp;                                         <label>Women Fragnances (238) </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className=' mt-9 m-4' >
                                ...
                                <div className='border border-black '>
                                    <div className='flex justify-between  pb-2 border-b border-black'>
                                        <p className='pl-2 text-[20px]'>0 selected
                                        </p>
                                        <p className='pr-2 underline text-[20px]'>Reset</p>
                                    </div>
                                    <div className='space-y-3  overflow-y-auto mt-3 mb-3 h-[400px] text-[20px] p-2'>
                                        ...
                                        <div>
                                            <input type='checkbox' />&nbsp;
                                            <label>Alexandre.J (11) </label>                                     </div>
                                        <div>
                                            <input type='checkbox' />&nbsp;
                                        ...
                                        <div>
                                            <input type='checkbox' />&nbsp;
                                            <label>Antonio Banderas (2)</label>                                     </div>
                                        <div>
                                            <input type='checkbox' />&nbsp;
                ...
                <div className='md:w-[1100px] w-auto'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:w-full'>
                        {products.map((item: Product, index: number) => (
                            <div key={index} className='md:w-full w-auto'>
